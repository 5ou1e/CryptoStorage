...
class Wallet(models.Model):
    ...
    is_scammer = models.BooleanField(null=True, default=False)
...
class TgSentWallet(models.Model):
    wallet = models.OneToOneField('Wallet', related_name='tg_sent', on_delete=models.CASCADE, primary_key=True)
    created_at = models.DateTimeField(db_index=True, auto_now_add=True, verbose_name='Создан')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='Обновлен')
