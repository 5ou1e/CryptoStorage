...
class WalletActivity(models.Model):
    ...
    is_part_of_transaction_with_mt_3_swappers = models.BooleanField(
        default=False,
        verbose_name="Является ли свап частью транзакции с 3 и более трейдерами",
    )
    is_part_of_arbitrage_swap_event = models.BooleanField(
        default=False, verbose_name="Является ли свап частью арбитраж свапа"
    )
