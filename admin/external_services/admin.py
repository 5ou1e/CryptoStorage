...
from .models import FlipsideCryptoAccount, FlipsideCryptoConfig


@admin.register(FlipsideCryptoConfig)
class FlipsideCryptoConfigAdmin(ModelAdmin):
    list_per_page = 30
...
@admin.register(FlipsideCryptoAccount)
class FlipsideCryptoAccountAdmin(ModelAdmin):
    list_per_page = 30
