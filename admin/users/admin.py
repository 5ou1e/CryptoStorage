...
class UserWalletAdmin(ModelAdmin):
    ...
    def get_urls(self):
        return [
            ...
            path(
                '<uuid:wallet_id>/update_stats_task_status/<str:task_id>/',
                update_wallet_stats_task_status_view,  # IMPORTANT: model_admin is required
                name="wallet_update_stats_task_status"
            ),
        ] + super().get_urls()