...
def upgrade() -> None:
    ...
    op.add_column("wallet", sa.Column("is_scammer", sa.Boolean(), server_default="false", nullable=False))
    op.add_column("wallet", sa.Column("is_bot", sa.Boolean(), server_default="false", nullable=False))
    op.add_column("wallet", sa.Column("sol_balance", sa.DECIMAL(precision=50, scale=20), nullable=True))
    ...
    op.create_index(
        "idx_wallet_last_stats_check", "wallet", [sa.literal_column("last_stats_check NULLS FIRST")], unique=False
    )
    op.create_index(
    ...
    op.drop_constraint("wallet_statistic_30d_wallet_id_fkey", "wallet_statistic_30d", type_="foreignkey")
    op.create_foreign_key(None, "wallet_statistic_30d", "wallet", ["wallet_id"], ["id"], ondelete="CASCADE")
    ...
    op.drop_constraint("wallet_statistic_all_wallet_id_fkey", "wallet_statistic_all", type_="foreignkey")
    op.create_foreign_key(None, "wallet_statistic_all", "wallet", ["wallet_id"], ["id"], ondelete="CASCADE")
    op.drop_constraint(
    ...
    op.create_foreign_key(
        None, "wallet_statistic_buy_price_gt_15k_30d", "wallet", ["wallet_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint(
    ...
    op.create_foreign_key(
        None, "wallet_statistic_buy_price_gt_15k_7d", "wallet", ["wallet_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint(
    ...
    op.create_foreign_key(
        None, "wallet_statistic_buy_price_gt_15k_all", "wallet", ["wallet_id"], ["id"], ondelete="CASCADE"
    )
    op.alter_column(
        "wallet_token", "id", existing_type=sa.INTEGER(), server_default=None, type_=sa.UUID(), existing_nullable=False
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "wallet_statistic_all_wallet_id_fkey", "wallet_statistic_all", "wallet", ["wallet_id"], ["id"]
    )
    op.drop_constraint(None, "wallet_statistic_7d", type_="foreignkey")
    op.create_foreign_key("wallet_statistic_7d_wallet_id_fkey", "wallet_statistic_7d", "wallet", ["wallet_id"], ["id"])
    op.drop_constraint(None, "wallet_statistic_30d", type_="foreignkey")
    op.create_foreign_key(
        "wallet_statistic_30d_wallet_id_fkey", "wallet_statistic_30d", "wallet", ["wallet_id"], ["id"]
    )
    ...
    op.create_foreign_key("tg_sent_wallet_wallet_id_fkey", "tg_sent_wallet", "wallet", ["wallet_id"], ["id"])
    op.create_table(
        "wallet_detail",
        ...
        sa.Column("sol_balance", sa.NUMERIC(precision=50, scale=20), autoincrement=False, nullable=True),
