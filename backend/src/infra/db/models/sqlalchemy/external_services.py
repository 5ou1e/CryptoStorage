...
from src.infra.db.models.sqlalchemy.common import Base, IntIDMixin, UUIDIDMixin
...
class FlipsideConfig(Base, UUIDIDMixin):
    ...
    swaps_parsed_untill_inserted_timestamp: Mapped[datetime | None] = mapped_column(
