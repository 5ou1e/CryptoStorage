...
from src.application.processes.wallet_statistic_updaters import calculations
from src.domain.entities.wallet import Wallet, WalletStatistic7d, WalletStatistic30d, WalletStatisticAll
